...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, E1_Pin|E2_Pin|E3_Pin|W3_Pin
                          |W2_Pin|W1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : E1_Pin E2_Pin E3_Pin W3_Pin
                           W2_Pin W1_Pin */
  GPIO_InitStruct.Pin = E1_Pin|E2_Pin|E3_Pin|W3_Pin
                          |W2_Pin|W1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
